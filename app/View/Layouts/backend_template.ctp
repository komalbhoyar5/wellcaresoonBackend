...
<head>
    ...
    <!-- Gritter -->
    <?php  echo $this->Html->css('../admin/js/plugins/gritter/jquery.gritter.css'); ?>
    <?php  echo $this->Html->css('../admin/css/animate.css'); ?>
    
    <?php  echo $this->Html->css('../admin/css/plugins/bootstrapTour/bootstrap-tour.min.css'); ?>
    <?php  echo $this->Html->css('../admin/css/bootstrap.min.css'); ?>
    <?php  echo $this->Html->css('../admin/css/style.css'); ?>
    <?php  echo $this->Html->css('../admin/css/plugins/sweetalert/sweetalert.css'); ?>
</head>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li>
                    <span class="m-r-sm text-muted welcome-message">Welcome to <?php echo $company_name; ?> admin panel</span>
                </li>
                <li class="dropdown">
